...
- The ready event bridge publishes at boot carries its own name, so a reader can tell which agent implementation the version beside it belongs to.
...
- Log in to bridge with bridge-login.
