...
- Bridge holds its own Anthropic credential rather than sharing Claude Code's, stored in the macOS Keychain and in ~/.claude/.credentials.json on platforms without one. Obtain a credential with bridge-login; bridge will not start until you have.
